...
import VectorOutput.Internal.VectorIO;
...
public class VectorIOTest {
    ...
    static String folder = TestObjects.Paths.testfolder;
    static VectorIO vio;
    static List<TokenVector> ltv;
    static TokenVector v1 = TestObjects.Objects.testTokenVector;
    static TokenVector v2 = TestObjects.Objects.testTokenVector2;
