...
import static fi.johannes.Core.AppConf.SupportedProcessingStrategy.TFIDF_Combined;
import static fi.johannes.Core.AppConf.SupportedProcessingStrategy.TFIDF_Keywords;
import static fi.johannes.Core.AppConf.SupportedProcessingStrategy.WikipediaTitles;
...
public class App implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        List<AppConf.SupportedProcessingStrategy> selectedStrategies
                = Arrays.asList(TFIDF_Keywords, TFIDF_Combined /*WikipediaTitles*/);
