...
public class ClustersStrategies {
    ...
    static {
        ...
        tMap.put(Options.SupportedClusters.TFIDF, new Options.SupportedProcessingStrategy[]{Options.SupportedProcessingStrategy.ConceptInsights, Options.SupportedProcessingStrategy.Alchemy});
    ...
    static {
        ...
        tMap.put(Options.SupportedClusters.TFIDF, new DeveloperCloudCluster());
